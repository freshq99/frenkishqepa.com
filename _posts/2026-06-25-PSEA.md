...
<p align="center" style="margin-top: 25px;">
  <a href="/assets/Relazione_Eterodina.pdf" download style="display: inline-block; padding: 14px 24px; background-color: #0076d6; color: white; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px rgba(0,0,0,0.15);">
