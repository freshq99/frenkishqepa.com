...
<iframe src="/assets/PresentazioneEterodina_finale.pdf" frameborder="0" width="100%" height="600px" style="border: 1px solid #ccc; border-radius: 6px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  Your browser does not support PDF viewing. <a href="/assets/PresentazioneEterodina_finale.pdf">Click here to download the slides.</a>
</iframe>
...
<p align="center" style="margin-top: 25px;">
  <a href="/assets/Eterodina_Belotti_Shqepa_Finale.pdf" download style="display: inline-block; padding: 14px 24px; background-color: #0076d6; color: white; border-radius: 6px; text-decoration: none; font-weight: bold; font-size: 16px; box-shadow: 0 4px 6px rgba(0,0,0,0.15);">
